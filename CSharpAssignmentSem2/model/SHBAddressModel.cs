...
namespace model CSharpAssignmentSem2.
{
        ...
        public bool UpdateBalance(SHBAccount currentLoggedInAccount, SHBTransaction transaction)
        {
            ...
            try
            {
                ...
                if (transaction.Type == 1)
                {
                    ...
                    {
                        Console.WriteLine("Không đủ tiền để thực hiện giao dịch.");
                        return false;
                    }
                ...
                {
                    throw new Exception("Không thể thực hiện giao dịch hoặc sửa thông tin tài khoản.");
                }
